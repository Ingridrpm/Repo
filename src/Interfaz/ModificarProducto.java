...
public class ModificarProducto extends JFrame implements ActionListener{
    ...
    public ModificarProducto(Usuario usuarioActual, Interno.Tienda tienda, int codigoProducto) {
        this.usuarioActual = usuarioActual;
        this.nombre = nombre;
        this.tienda = tienda;
        this.codigoProducto = codigoProducto;
        this.productoActual = this.tienda.getProducto(codigoProducto);
        configurarVentana();
        addLabel(new JLabel(), "Modificar Producto", 50, 50, 400, 40, 30);
        ...
        addButton("Modificar Producto",200,250,200,30);
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == this.btnAgregarProducto){
            this.tienda.modifocarProducto(this.codigoProducto,txtNombre.getText(), Double.parseDouble(txtPrecio.getText()), cbTipo.getSelectedIndex()+1);
            setVisible(false);
